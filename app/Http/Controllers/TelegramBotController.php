...
فعالیت های داخل شرکت عموما خلاقانه بوده و فضای بسیار بازی را برای آموزش دیدن و پیشرفت کردن ساخته است و شما با مواردی روبه رو خواهید بود که در هیج جای دیگری مشابهی نخواهد داشت .
                            \n
محل کنونی شرکت جردن، خیابان تابان غربی،موسسه آموزش عالی امیرکبیر،طبقه دوم،واحد۲۰۲ میباشد .
                            ";
                            \Telegram::sendMessage(
                                [
                                    'chat_id' => $chat_id,
                        ...
                        case 'زمان های کارآموزی':
                            $text="شرکت هر روز هفته از ساعت ۱۰ الی ۱۸ باز خواهد بود و کارآموزان بعد از کسر شدن زمان های مشغول دانشگاهیشان باقی زمان خود را در داخل شرکت خواهند گذراند. بنابر تشخیص سرپرست کارآموزی بعد از مدتی امکان انجام دورکاری به عنوان بخشی از زمان نیز ممکن خواهد شد.";
                            \Telegram::sendMessage(
                                [
                                    'chat_id' => $chat_id,
                                    'text' => $text,
